...
# Formula: ROOT_CHORD_LENGTH = 1.6 * WingGenerator.HUB_RADIUS
# Where HUB_RADIUS = 0.00435 / 2.0 = 0.002175 (defined in WingGenerator class)
# Therefore: ROOT_CHORD_LENGTH = 1.6 * 0.002175 = 0.00348
...
ROOT_CHORD_LENGTH = 0.00348  # Fixed chord length at root for rotor hub union (1.6 * HUB_RADIUS)
