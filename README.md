...
# A full example
python generate_params.py output.csv --overall-length 0.03 --n-wings 2 --average-chord-length 0.005 --chord-length-variance 1 --max-twist-angle 10 --chord-max-thickness 20
```
